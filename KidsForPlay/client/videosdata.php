...
<?php require_once('header.php')?>
		...
		<section id="titleArea">
			<div class="container">
				<div class="row">
					<div class="span12">
						<h3>Vidoes for better undestanding</h3>	
					</div>
				</div>
			</div>
		</section>
...
while($row = mysqli_fetch_assoc($result)){
    ...
    ?>				  
							...
							<iframe width="520" height="345" src="<?php echo $row['v_link']; ?>">
							</iframe>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
      <?php
}
