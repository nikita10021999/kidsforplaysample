...
{	
    ...
    $sql= "select * from display_master where display_id=5"; //"call sp()";
...
<?php require_once('header.php'); ?>
			...
			<div class="container">
				<div class="row">
					<div class="span12 breadcrumb">
						<span xmlns:ib="http://rdf.data-vocabulary.org/#"><div class="ib-trail">
		...
		<section id="titleArea">
			<div class="container">
				<div class="row">
					<div class="span12">
						<h3>Animals</h3><p>Learn name of Animals with sounds.</p>	
					</div>
				</div>
			</div>
		</section>
...
while($row = mysqli_fetch_assoc($result)){
    ...
    ?>				  
							...
							<h3 ondblclick="document.getElementById('fullaudio<?php echo $row['Displaymaster_id']; ?>').play();"><?php echo $row['Name']; ?></h3>	
							<div style="display:none">
							<audio  id="fullaudio<?php echo $row['Displaymaster_id']; ?>">
								<source src="<?php echo $row['File2']; ?>" type="audio/mpeg" >
							</audio>					
							<audio  id="myAudio<?php echo $row['Displaymaster_id']; ?>">
								<source src="<?php echo $row['File']; ?>" type="audio/mpeg" >
							</audio>	
							</div>
						  <a onclick="document.getElementById('myAudio<?php echo $row['Displaymaster_id']; ?>').play();" data-toggle="tooltip" data-placement="left" title="Click to learn">
						  <img class="grab" width="10%"  src="<?php echo $row['Image']; ?>" alt="" style="width: 200px;height: 200px"></a>
