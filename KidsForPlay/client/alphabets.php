...
{	
    ...
    $sql= "select * from display_master where display_id=1 "; //"call sp()";
...
<?php require_once('header.php'); ?>
		...
		<section id="titleArea">
			<div class="container">
				<div class="row">
					<div class="span12">
						<h3>Alphabets</h3><p>Learn alphabets with sounds.</p>	
					</div>
				</div>
			</div>
		</section>
...
while($row = mysqli_fetch_assoc($result)){
    ...
    ?>				  
						  ...
						  <img class="grab" width="10%" ondblclick="document.getElementById('fullaudio<?php echo $row['Displaymaster_id']; ?>').play();" src="<?php echo $row['Image']; ?>" alt=""
