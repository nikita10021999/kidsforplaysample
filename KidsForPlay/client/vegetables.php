...
{	
    ...
    $sql= "select * from display_master where display_id=4 order by name"; //"call sp()";
...
<?php require_once('header.php'); ?>
		...
		<section id="titleArea">
			<div class="container">
				<div class="row">
					<div class="span12">
						<h3>Vegetables</h3><p>Learn different vegetables with sounds.</p>	
					</div>
				</div>
			</div>
		</section>
...
while($row = mysqli_fetch_assoc($result)){
    ...
    ?>				  
						  ...
						  <img class="grab" width="10%" src="<?php echo $row['Image']; ?>" alt=""
