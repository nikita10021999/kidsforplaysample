<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sq = "INSERT INTO contact_us (name,email,phone,message) VALUES ('$name','$email',$num,'$msg')";
...
<?php require_once('header.php'); ?>	
  ...
  <aside id="sidebarLeft">
      <div id="text-8" class="widget"><h2>KidsForPlay</h2>			<div class="textwidget"><p><strong>Complaints and feedback</strong>
<br>
For website related complaints and feedback contact us by filling the form.
</p>
<br/> 
<p> <!--- <a class="readmore" href="#">read more about us</a> ---> </p></div>
		</div>  </aside>   <!-- sidebar -->
...
<form method="post">
  ...
  <div class="container">
    ...
    <input type="text" placeholder="Enter Email-id" name="em" required>

    <label for="num"><b>Phone number</b></label>
    <input type="number" placeholder="Enter phone number" name="num" required>

    <label for="message"><b>Message</b></label>
    <textarea rows="6" name="message" placeholder="Your Feedback or Complaint here"></textarea>
