...
<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT * FROM  userinfo WHERE email = '$email' and passsword = '$pd'";
...
<?php require_once('header.php'); ?>	
		...
		<section id="titleArea">
			<div class="container">
				<div class="row">
					<div class="span12">
						<h3>Login</h3><p>Login to experience the best. </p>	
					</div>
				</div>
			</div>
		</section>
  ...
  <aside id="sidebarLeft">
      <div id="text-8" class="widget"><h2>KidsForPlay</h2>			<div class="textwidget"><p><strong>Login to shop and learn.</strong>
<br>
Kids can learn the best and you can shop the best.
</p>
<br/> 
