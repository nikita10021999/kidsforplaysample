...
$sql= "select * from game limit $start_from,$num_per_page"; //"call sp()";
$result=mysqli_query($db,$sql);
  
while($row = mysqli_fetch_assoc($result)){

  $per_sql= "select * from game";
	  ...
	  <script type="text/javascript">
		...
		//   $(document).ready(function(){
			  ...
			  $('#my_radio_box').change(function(){
				//   selected_value = $("input[name='choice']:checked").val();
				//   document.getElementById("demo").innerHTML=selected_value;
...
<div id="gallerywrapper">
      <div id="gallery">
        <div id="pic1">
          ...
          <img src="<?php echo $row['picture']; ?>" style="width: 500px;height: 400px" alt="Image 1">
          <a class="previous" href="#pic5"> <?php echo "<a href='test.php?page=".($page-1)."' class='btn btn-danger'>Previous</a>";?></a>

          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

          
          <a class="next" href="#pic2"><?php echo "<a href='test.php?page=".($page+1)."' class='btn btn-danger'>Next</a>"; ?></a>
          <br><br>
          <input name="correct" id="ans" type="hidden" value="<?php echo $row['ans']; ?>" />
          <input name="choice" onchange="rd_change(this.value)" type="radio" value="<?php echo $row['o1']; ?>" /><font size=4><b><?php echo $row['o1']; ?></b></font>
          <input name="choice" onchange="rd_change(this.value)" type="radio" value="<?php echo $row['ans']; ?>" /><font size=4><b><?php echo $row['ans']; ?></b></font>
          <input name="choice" onchange="rd_change(this.value)" type="radio" value="<?php echo $row['o2']; ?>" /><font size=4><b><?php echo $row['o2']; ?></b></font>
          <input name="choice" onchange="rd_change(this.value)" type="radio" value="<?php echo $row['o3']; ?>" /><font size=4><b><?php echo $row['o3']; ?></b></font>
        </div>
       <br><br>
      </div>
</div>
