	...
	<?php require_once('header.php'); ?>
		...
		<section id="titleArea">
			<div class="container">
				<div class="row">
					<div class="span12">
						<h3>Thank You</h3><p>To shop with us. </p>	
					</div>
				</div>
			</div>
		</section>
  ...
  <aside id="sidebarLeft">
                <div class="span9">  
                    ...
                    <div class="wrap_content">         
                    			...
                    			<h1>Shop for more items</h1>
<div class="clearfix box">
<img src="../images/products/deer.jpg" alt="yay-906310" width="300" height="199" class="alignleft size-medium wp-image-114" srcset="../images/products/deer.jpg 100w, ../images/products/deer.jpg 671w" sizes="(max-width: 100px) 100vw, 100px" /></p>
<h3>Toys</h3>
<p>Shop more toys, here. </p>
<p><a class="read" href="shopdemo.php">Shop</a><br />
</div>
<div class="clearfix box">
<img src="../images/products/bedstories.jpg" alt="yay-528871" width="300" height="199" class="alignleft size-medium wp-image-104" srcset="../images/products/bedstories.jpg 500w, ../images/products/bedstories.jpg 671w" sizes="(max-width: 500px) 100vw, 500px" /></p>
<h3>Books</h3>
<p>Get some new book on KidsForPlay </p>
<p><a class="read" href="shopdemo.php">Shop</a><br />
</div>
<div class="clearfix box">
<img src="../images/products/denim.jpg" alt="yay-529339" width="300" height="199" class="alignleft size-medium wp-image-105" srcset="../images/products/denim.jpg 500w, ../images/products/denim.jpg 671w" sizes="(max-width: 500px) 100vw, 500px" /></p>
<h3>Clothes</h3>
<p>Contine shopping here for more clothes.. </p>
<p><a class="read" href="shopdemo.php">Shop</a><br />
</div>
